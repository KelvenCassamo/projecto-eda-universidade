...
public class SimpleLinkedList <T>{
	...
	public T next(int p) throws IlligalTailCallException {
		...
		if(p < 1)
			throw new IlligalTailCallException("argumento invalido");
	...
	public T prev(int p) throws IlligalHeadCallException {
		if(p <= 1)
			throw new IlligalHeadCallException("Chamada de prev para uma posição invalida");
		
		if(p > nElements)
			throw new IlligalHeadCallException("argumento invalido");
